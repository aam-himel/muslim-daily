const rabbanaDuas = [
  {
    ...
    spellingEng: 'Rabbana taqabbal minna innaka antas Sameeaul Aleem',
    banglaTranslation:
      'পরওয়ারদেগার! আমাদের থেকে কবুল কর। নিশ্চয়ই তুমি শ্রবণকারী, সর্বজ্ঞ।',
  ...
  },
  {
    ...
    banglaTranslation:
      'হে পরওয়ারদেগার! আমাদিগকে দুনয়াতেও কল্যাণ দান কর এবং আখেরাতেও কল্যাণ দান কর এবং আমাদিগকে দোযখের আযাব থেকে রক্ষা কর।',
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আমাদের মনে ধৈর্য্য সৃষ্টি করে দাও এবং আমাদেরকে দৃঢ়পদ রাখ-আর আমাদের সাহায্য কর সে কাফের জাতির বিরুদ্ধে।',
    source: '',
    tags: [],
  },
  {
    ...
    spellingEng: 'Rabbana laa tu’aakhiznaaa in naseenaaa aw akhtaanaa',
    banglaTranslation:
      'হে আমাদের পালনকর্তা, যদি আমরা ভুলে যাই কিংবা ভুল করি, তবে আমাদেরকে অপরাধী করো না।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা! এবং আমাদের উপর এমন দায়িত্ব অর্পণ করো না, যেমন আমাদের পূর্ববর্তীদের উপর অর্পণ করেছ',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের প্রভূ! এবং আমাদের দ্বারা ঐ বোঝা বহন করিও না, যা বহন করার শক্তি আমাদের নাই। আমাদের পাপ মোচন কর। আমাদেরকে ক্ষমা কর এবং আমাদের প্রতি দয়া কর। তুমিই আমাদের প্রভু। সুতরাং কাফের সম্প্রদায়ের বিরুদ্ধে আমাদের কে সাহায্যে কর।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আমরা ঈমান এনেছি, কাজেই আমাদের গোনাহ ক্ষমা করে দাও আর আমাদেরকে দোযখের আযাব থেকে রক্ষা কর।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা! মোচন করে দাও আমাদের পাপ এবং যা কিছু বাড়াবাড়ি হয়ে গেছে আমাদের কাজে। আর আমাদিগকে দৃঢ় রাখ এবং কাফেরদের উপর আমাদিগকে সাহায্য কর।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'পরওয়ারদেগার! এসব তুমি অনর্থক সৃষ্টি করনি। সকল পবিত্রতা তোমারই, আমাদিগকে তুমি দোযখের শাস্তি থেকে বাঁচাও।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা! আমরা নিশ্চিতরূপে শুনেছি একজন আহবানকারীকে ঈমানের প্রতি আহবান করতে যে, তোমাদের পালনকর্তার প্রতি ঈমান আন; তাই আমরা ঈমান এনেছি।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা! অতঃপর আমাদের সকল গোনাহ মাফ কর এবং আমাদের সকল দোষত্রুটি দুর করে দাও, আর আমাদের মৃত্যু দাও নেক লোকদের সাথে।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    spellingEng: 'Rabbanaaa aamannaa faktubnaa ma’ash shaahideen',
    banglaTranslation:
      'হে আমাদের প্রতি পালক, আমরা মুসলমান হয়ে গেলাম। অতএব, আমাদেরকেও মান্যকারীদের তালিকাভুক্ত করে নিন।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আল্লাহ আমাদের পালনকর্তা আমাদের প্রতি আকাশ থেকে খাদ্যভর্তি খাঞ্চা অবতরণ করুন। তা আমাদের জন্যে অর্থাৎ, আমাদের প্রথম ও পরবর্তী সবার জন্যে আনন্দোৎসব হবে এবং আপনার পক্ষ থেকে একটি নিদর্শন হবে। আপনি আমাদের রুযী দিন। আপনিই শ্রেষ্ট রুযীদাতা।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা আমরা নিজেদের প্রতি জুলম করেছি। যদি আপনি আমাদেরকে ক্ষমা না করেন এবং আমাদের প্রতি অনুগ্রহ না করেন, তবে আমরা অবশ্যই অবশ্যই ধ্বংস হয়ে যাব।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation: 'হে আমাদের প্রতিপালক, আমাদেরকে এ জালেমদের সাথী করো না।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের প্রতিপালক আমাদের ও আমাদের সম্প্রদায়ের মধ্যে ফয়সালা করে ছিল যথার্থ ফয়সালা। আপনিই শ্রেষ্টতম ফসলা ফয়সালাকারী।',
    source: '',
    tags: [],
  },
  {
    ...
    spellingEng: 'Rabbanaaa afrigh ‘alainaa sabranw wa tawaffanaa muslimeen',
    banglaTranslation:
      'হে আমাদের পরওয়ারদেগার আমাদের জন্য ধৈর্য্যের দ্বার খুলে দাও এবং আমাদেরকে মুসলমান হিসাবে মৃত্যু দান কর।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আমরা আশঙ্কা করি যে, সে আমাদের প্রতি জুলুম করবে কিংবা উত্তেজিত হয়ে উঠবে।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা! আমরা বিশ্বাস স্থাপন করেছি। অতএব তুমি আমাদেরকে ক্ষমা কর ও আমাদের প্রতি রহম কর। তুমি তো দয়ালুদের মধ্যে শ্রেষ্ঠ দয়ালু।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমার পালনকর্তা, আমাদের কাছথেকে জাহান্নামের শাস্তি হটিয়ে দাও। নিশ্চয় এর শাস্তি নিশ্চিত বিনাশ; \nবসবাস ও অবস্থানস্থল হিসেবে তা কত নিকৃষ্ট জায়গা।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আমাদের স্ত্রীদের পক্ষ থেকে এবং আমাদের সন্তানের পক্ষ থেকে আমাদের জন্যে চোখের শীতলতা দান কর এবং আমাদেরকে মুত্তাকীদের জন্যে আদর্শস্বরূপ কর।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation: 'আমাদের পালনকর্তা ক্ষমাশীল, গুণগ্রাহী।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আর তাদেরকে দাখিল করুন চিরকাল বসবাসের জান্নাতে, যার ওয়াদা আপনি তাদেরকে দিয়েছেন এবং তাদের বাপ-দাদা, পতি-পত্নী ও সন্তানদের মধ্যে যারা সৎকর্ম করে তাদেরকে। নিশ্চয় আপনি পরাক্রমশালী, প্রজ্ঞাময়। এবং আপনি তাদেরকে অমঙ্গল থেকে রক্ষা করুন। আপনি যাকে সেদিন অমঙ্গল থেকে রক্ষা করবেন, তার প্রতি অনুগ্রহই করবেন। এটাই মহাসাফল্য।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আমাদেরকে এবং ঈমানে আগ্রহী আমাদের ভ্রাতাগণকে ক্ষমা কর এবং ঈমানদারদের বিরুদ্ধে আমাদের অন্তরে কোন বিদ্বেষ রেখো না।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation: 'হে আমাদের পালনকর্তা, আপনি দয়ালু, পরম করুণাময়।',
    source: '',
    tags: [],
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা! আমরা তোমারই উপর ভরসা করেছি, তোমারই দিকে মুখ করেছি এবং তোমারই নিকট আমাদের প্রত্যাবর্তন।',
    source: '',
    tags: [],
  },
  {
  ...
  },
  {
    ...
    banglaTranslation:
      'হে আমাদের পালনকর্তা, আমাদের নূরকে পূর্ণ করে দিন এবং আমাদেরকে ক্ষমা করুন। নিশ্চয় আপনি সবকিছুর উপর সর্ব শক্তিমান।',
    source: '',
    tags: [],
  },
];

export default rabbanaDuas;
